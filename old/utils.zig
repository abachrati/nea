...
/// wrapping around within an internal buffer.
pub fn RingArray(comptime T: type) type {
    return struct {
        ...
        /// Initialize a RingList with the given capacity. The resulting capacity will be `num`
        /// exactly.
...
/// memory, instead wrapping around within an internal buffer. The same allocator must be used
/// throughout the list's lifetime.
